...
public class SwitchingNewTab extends CommonFunctions {
	...
	public void switchTab() throws Exception {
		...
		clickByAnyLocator(By.id("tabButton"));
		System.out.println(driver.getWindowHandles());

		// Switch to child tab then close only child tab
		switchAndCloseNewTab();
		Thread.sleep(5000);

		// Click on newwindowbutton
		clickByAnyLocator(By.id("windowButton"));
		// Close the current window
		// driver.close();

		// close the parent and its related windows(Child)
		// driver.quit();
	}
